...
# 说明：此快速中值滤波算法，没有cv2.medianBlur效果好，后期会进行优化，更深一步去理解中值滤波原理
...
denoise_img = cv2.medianBlur(noise_img,9)
selfDenoise_img = quickMedianFiltering(noise_img)
plt.subplot(131)
my_show(noise_img)
plt.subplot(132)
my_show(denoise_img)
plt.subplot(133)
my_show(selfDenoise_img)